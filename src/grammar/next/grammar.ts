...
export namespace $$ {
  ...
  export type FunctionAttribute = $.Located<{
    ...
    readonly name: "get" | mutates | $extends | virtual | override | inline | $abstract;
  }>;
  export type FunctionAttribute$noSkip = $.Located<{
    readonly $: "FunctionAttribute";
    readonly name: "get" | mutates$noSkip | $extends$noSkip | virtual$noSkip | override$noSkip | inline$noSkip | $abstract$noSkip;
  }>;
...
export const FunctionAttribute: $.Parser<$$.FunctionAttribute> = $.loc($.field($.pure("FunctionAttribute"), "$", $.field($.alt($.left($.str("get"), $.star(space$noSkip)), $.alt($.ref(() => mutates), $.alt($.ref(() => $extends), $.alt($.ref(() => virtual), $.alt($.ref(() => override), $.alt($.ref(() => inline), $.ref(() => $abstract))))))), "name", $.eps)));
export const FunctionAttribute$noSkip: $.Parser<$$.FunctionAttribute$noSkip> = $.loc($.field($.pure("FunctionAttribute"), "$", $.field($.alt($.str("get"), $.alt($.ref(() => mutates$noSkip), $.alt($.ref(() => $extends$noSkip), $.alt($.ref(() => virtual$noSkip), $.alt($.ref(() => override$noSkip), $.alt($.ref(() => inline$noSkip), $.ref(() => $abstract$noSkip))))))), "name", $.eps)));
